    ...
    <div className='py-4'>
      ...
      <ul>
        <li className='py-2 pl-2'>
          <Link to={path.home} className='px-2 relative font-semibold text-orange'>
      ...
      <div className='bg-gray-300 h-[1px] my-4' />
      <Button className='w-full bg-orange py-2 rounded-md uppercase text-white hover:bg-orange/80'>Xóa tất cả</Button>
    </div>
  )
}
